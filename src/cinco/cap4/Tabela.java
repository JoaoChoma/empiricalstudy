...
//package cinco.cap5;
import cinco.cap4.Item; // @{\it vide Programa~\ref{prog:interfaceitem}}@
import cinco.cap4.MeuItem; // @{\it vide Programa~\ref{prog:tipoitem}}@
import cinco.cap4.PermutacaoRandomica;
...
public class Tabela {
  ...
  public int binaria (Item chave) { 
    ...
    do { 
      i = (esq + dir) / 2;
      if (chave.compara (this.registros[i]) > 0) esq = i + 1; /*(P4) 30*/
      else dir = i - 1;  /*(P4) 30*/

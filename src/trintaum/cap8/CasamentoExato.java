...
/* 0007 */       int k = i; int j = 0;
/* 0008 */       while ((j < m) && (T.charAt (k) == P.charAt (j))) { j++; k++; } /*(p4)->4 T*/
/* 0009 */       if (j == m) System.out.println ("Casamento na posicao: " + i);
/* 0010 */     }
/* 0011 */   }
...
/* 0031 */     int i = m - 1;
/* 0032 */     while (i < n) { // @{\it Pesquisa}@
/* 0033 */       int k = i; int j = m - 1;
/* 0034 */       while ((j >= 0) && (T.charAt (k) == P.charAt (j))) { j--; k--; } /*(p4)->26 T*/
/* 0035 */       if (j < 0)
...
/* 0045 */     int i = m - 1;
/* 0046 */     while (i < n) { // @{\it Pesquisa}@
/* 0047 */       int k = i; int j = m - 1;
/* 0048 */       while ((j >= 0) && (T.charAt (k) == P.charAt (j))) { j--; k--; } /*(p4)->40 T*/ /*(p4)->47 j and k*/
/* 0049 */       if (j < 0)

package vinte.cap5;
import vinte.cap4.Item; // @{\it vide Programa~\ref{prog:interfaceitem}}@
import vinte.cap4.MeuItem; // @{\it vide Programa~\ref{prog:tipoitem}}@
import vinte.cap4.PermutacaoRandomica;
